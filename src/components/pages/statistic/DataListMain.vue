...
import DataCardMain from "@/components/pages/statistic/DataCardMain.vue";
...
export default {
  ...
  computed: {
    total() {
      return fossil[0][this.selectedYear] + hydro[0][this.selectedYear] + nuclear[0][this.selectedYear] + solar[0][this.selectedYear] + wind[0][this.selectedYear]
    }
  }
}
</script>
